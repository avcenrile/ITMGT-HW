...
def material_waste(total_material: int, material_units: str, num_jobs: int, job_consumption: int):
    ...
    final_material = total_material - consumed
    return(str(final_material) + material_units)
    

def interest(principal: int, rate: float, periods: int):
    '''Interest.
    3 points.
...
def body_mass_index(weight: int, height: list):
    '''Body Mass Index.
    3 points.
